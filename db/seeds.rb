...
Item.create([ 
    [hierarchy_id: 10, place_id: 1, description: 'El león (Panthera leo) es un mamífero carnívoro de la familia de los félidos y una de las 4 especies del género Panthera. Algunos machos, excepcionalmente grandes, llegan a pesar hasta 250 kg, lo que los convierte en el segundo félido viviente más grande después del tigre. Los leones salvajes viven en África subsahariana y Asia, con una población en peligro crítico al noroeste de la India, habiendo desaparecido del norte de África, de Oriente Próximo y del oeste de Asia en tiempos históricos.', visits: 0, name: 'León', cientific_name: 'Panthera Leo', visible: 1],
